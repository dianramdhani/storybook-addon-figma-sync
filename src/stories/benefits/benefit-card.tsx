  ...
  return (
    <div
      className={cn(
        ...
        'md:min-h-82.5 lg:absolute lg:top-10 lg:h-115 lg:w-76',
    ...
    >
      <Card
        className={cn(
          'size-full flex flex-col justify-between gap-6',
          'rounded-2xl border-none p-6 shadow-lg',
          'transition-all duration-300 ease-in-out',
          'hover:bg-gradient-soft-blue hover:-translate-y-2 hover:shadow-xl',
        )}
      >
        <CardHeader className="flex flex-col gap-2.5 p-0">
          <CardTitle className="text-[26px]">{card.title}</CardTitle>
          <CardDescription className="text-[17px] lg:h-30">{card.description}</CardDescription>
        </CardHeader>
